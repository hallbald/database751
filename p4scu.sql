...
ALTER TABLE team
  ADD CONSTRAINT team_team_fk FOREIGN KEY (coach_id) REFERENCES coach (coach_id);

ALTER TABLE player
  ADD CONSTRAINT player_team_fk FOREIGN KEY (team_id) REFERENCES team (team_id);

ALTER TABLE coach
  ADD CONSTRAINT coach_family_fk FOREIGN KEY (coach_family_id) REFERENCES family (family_id);

ALTER TABLE player
  ADD CONSTRAINT player_family_fk FOREIGN KEY (player_family_id) REFERENCES family (family_id);
